...
from ambulance_system.models import TrafficConditionLog, Monitor, Location, ResponsibleUnit, TrafficCondition, \
    Ambulance, AmbulanceSchedule
...
def table(request):
    if request.method == 'POST':
        ...
        log = TrafficConditionLog.objects.create(Monitor=monitor, TrafficCondition=condition, Datetime=time,
                                                 ResponsibleUnit=unit, Solved=False, Processed=process)
        log.save()
